...
<script type="text/javascript">
    $(function(){
        ...
        $("#master").datagrid({
            url:"${pageContext.request.contextPath}/master/selectAll",
            columns:[[{
                title:"上师编号",
                field:"master_id",
                width:220,
                    ...
                    buttons:[{
                        ...
                        handler:function(){
                            ...
                            $("#addMaster").dialog("close",{
                                href:"${pageContext.request.contextPath}/main/master.jsp"
                            });
        ...
        $("#batchMaster").linkbutton({
            onClick:function(){
                ...
                $("#lotSizeMaster").dialog({
                    ...
                    href:"${pageContext.request.contextPath}/main/batchMaster.jsp",
                    modal:true,
                    shadow:true,
                    buttons:[{
                        iconCls:"icon-table_save",
...
<div id="keyWord" style="width:120px">
    ...
    <div data-options="name:'name',iconCls:'icon-client'"></div>
</div>
